              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                    ...
                    <div className="w-full mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      <div className="mt-2 w-full">
                        <p className=" text-gray-500">
                          {task && (
                            <textarea
                              className={`w-full outline-none text-lg ${task.styles}`}
                ...
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row justify-between items-center sm:px-6">
                  ...
                  <div className="sm:flex sm:flex-row-reverse sm:px-6">
                    <button
                      type="button"
                      className="inline-flex w-full justify-center items-center rounded-md bg-sky-600 hover:bg-sky-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto"
                      onClick={() => {
                        updateTask()
                        setOpen(false)
                        setisOpen(false)
